...
useEffect(() => {
  const fetchData = async () => {
    try {
      // Fetch project data
      const projectResponse = await axios.get(`http://10.8.0.13:5030/get-project/${projectID}`);
      ...
      const orgIDResponse = await axios.get(`http://10.8.0.13:5030/get-orgID/${projectData.projectOwner}`);
